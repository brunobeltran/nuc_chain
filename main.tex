...
%lengths
%TODO make figure 4 using 41bp kuhn lengths. two panels. in one, zoom into kuhn
...
%TODO switch figures 3 adn 4 in order
...
We then show that even with very little variance in nucleosome spacing, the
    structure structure of the chromatin fiber exhibits a kind of universality.
...
At zero temperature, Chasles' theorem implies that these homogenous chains will
    trace out a helix whose structure is determined solely by the spherical
...
The Kuhn lengths  of the various homogenous fibers reflect this.
