...
\begin{figure}[t]
    \includegraphics[width=0.35\linewidth]{./figures/fig-2a-kuhn-all.png}
    \includegraphics[width=0.35\linewidth]{./figures/fig-2b-mc-example.png}
    \\
...
\end{figure}
\begin{figure}[t]
    \includegraphics[width=0.95\linewidth]{./figures/fig-4-exp-variance.png}
    \caption{A caption.}
\end{figure}
\begin{figure}[t]
