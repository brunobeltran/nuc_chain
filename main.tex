...
\begin{figure}
    \mbox{%
        \subfloat[][]{\label{fig:r2-homo-wlc}
            \includegraphics{../../deepti/nuc_chain_tmp/plots/PRL/fig2a_r2_homogenous_vs_wlc-scaled.pdf}
        }%
        \subfloat[][]{\label{fig:homo-kuhn-zoom}
...
\begin{figure}
    ...
    \mbox{%
        \subfloat[][]{\label{fig:exp-r2}
            \includegraphics{../../deepti/nuc_chain_tmp/plots/PRL/fig4a_r2_exp_vs_wlc-scaled.pdf}
        }%
