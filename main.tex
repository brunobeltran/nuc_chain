...
Recall that the Kuhn length, $b$, measures the asymptotic behavior of the end-to-end
distance of the chain as a function of how long the chain is.
More specifically, the end to end distance $\RR$ will always take the form $\RR
= bL$ for large enough $L$.
...
% conclusions for multiscale models of chromatin
