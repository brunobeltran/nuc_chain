...
While simulations have historically highlighted huge discrepancies in chromatin
    organization as a function of nucleosome repeat length~\cite{bascom2017a,
    ...
    nucleosome positioning on chromatin's structure.
...
This equation can be solved analytically in Fourier space
    ...
    D-functions~\cite{spakowitz2006}, the eigenfunctions of the heat equation on
    $SO(3)$.
