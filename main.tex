...
In contrast, we show that any heterogeneity in the nucleosome spacing
    eliminates this sensitivity, allowing us to robustly predict the Kuhn length
    of chromatin in various cell types.
In addition, we show by merely rearranging the positions of intervening
...
At zero temperature, where linkers are rigid rods, the nucleosomes
...
Since dsDNA has \SI{10.5}{\basepair} helical periodicity, every 21st linker
    length will create a similar fiber.
