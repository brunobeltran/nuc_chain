...
\begin{figure}
    \mbox{%
        \subfloat[][]{\label{fig:r2-homo-wlc}
            \includegraphics{../../plots/PRL/fig2a_r2_homogenous_vs_wlc-scaled.pdf}
        }%
        \subfloat[][]{\label{fig:homo-kuhn-zoom}
            \includegraphics{../../plots/PRL/fig2b_kuhn_length_in_nm_31to51links_0unwraps-with-renderings.pdf}
        }%
...
For arbitrarily long linker lengths, $\meanli\to\infty$, this relationship breaks
    ...
    Supplemental Figure~XX).%~\ref{fig:homo-kuhn-large}).
...
\begin{figure}
    \centering
    \includegraphics{../../plots/PRL/fig-3-kuhn_length_vs_window_size_41_sigma0to40-v4.pdf}
...
%We say this same statement when discussing homogenous chains, and I think above
%setnence makes it pretty clear that this is the case
...
%This limiting case corresponds to a chain with approximately uniform $\phi$.
...
\begin{figure}
    \centering
    \mbox{%
        \subfloat[][]{\label{fig:exp-r2}
            \includegraphics{../../plots/PRL/fig4a_r2_exp_vs_wlc-scaled.pdf}
        }%
        \subfloat[][]{\label{fig:hetero-kuhn}
            \includegraphics{../../plots/PRL/fig4b_kuhn_exponential-with-images.pdf}
        }%
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth,height=0.4\linewidth]{../../plots/PRL/fig5_looping_hetero31to52bp_bold3curves.pdf}
