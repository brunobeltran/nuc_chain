...
Most notably, in a nucleosome, DNA winds around a histone octamer to form an
...
%TODO include discussion of how homogenous chain model is same as helical
% chain previously used for dsDNA~\cite{liu2011a}, how full model is related
% to kinked chain~\cite{wiggins2005}, ....
%TODO also note force response of our polymer has previously been discussed
% in~\cite{popov2005}.
...
Linker DNA connecting adjacent nucleosomes is typically much shorter than the
    ...
    $\approx$\SI{50}{\basepair} in human cells~\cite{schones2008}.
Therefore, the chromatin fiber is well approximated by a series of stiff rods
    connected at angles determined by the structure of the nucleosome, as in
    Figure~\ref{fig:nuc-geo}.

While computational models of the chromatin fiber abound~\cite{bascom2017a,
...
At zero temperature, where the linkers are rigid rods, each linker/nucleosome
    pair can be thought of as a fixed translation/rotation.
Due to Chasles's theorem, this means that repeating this same linker length will
